    ...
    <div className="min-h-screen bg-white text-black font-sans dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="container max-w-4xl mx-auto px-6 py-12">
        ...
        {hasMatches ? (
          ...
          <div className="text-center py-20 bg-gray-50 rounded-xl border border-dashed border-gray-300 dark:border-slate-700 dark:bg-slate-900/70">
