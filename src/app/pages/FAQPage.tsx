      ...
      <main>
        <section className="border-b border-white/50 bg-white/62 px-4 py-16 backdrop-blur-sm dark:border-white/10 dark:bg-slate-900/38">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              Find answers to common questions about student benefits, financial aid, food assistance,
              health coverage, and transportation support in Massachusetts.
            </motion.p>
          </div>
        </section>

        <section className="border-b border-white/50 bg-white/45 px-4 py-14 backdrop-blur-sm dark:border-white/10 dark:bg-slate-900/30">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {BENEFIT_OVERVIEWS.map((item) => (
                <article
                  key={item.title}
                  className="rounded-2xl border border-white/70 bg-white/80 p-6 shadow-[0_20px_50px_-42px_rgba(15,23,42,0.36)] backdrop-blur-sm dark:border-white/10 dark:bg-slate-900/72"
                >
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <div className="mt-4 text-sm text-gray-500 dark:text-slate-400">
                ...
                {activeFilterId !== 'all' ? ` in ${activeFilter.label}` : ''}.
              </div>
            </motion.div>
