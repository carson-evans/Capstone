          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-10">
              ...
              >
                ...
                >
                  CommonMASS is a simple, secure way for Massachusetts students and residents to check
                  possible eligibility for student aid, food assistance, health coverage, MBTA discounts,
                  and other support programs. Get matched in minutes and leave with clear next steps.
                </motion.p>
                ...
                >
                  ...
                  <Link
                    to="/faq"
                    className="inline-flex items-center rounded-full border border-[#1e3a5f]/15 bg-white px-6 py-3 text-base font-semibold text-[#1e3a5f] shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#1e3a5f]/30 hover:bg-[#f8fafc] dark:border-sky-200/20 dark:bg-slate-900 dark:text-sky-200 dark:hover:border-sky-200/35 dark:hover:bg-slate-800"
                  >
                    Browse FAQ
                  </Link>
                </motion.div>
              ...
              <div
                className="relative mx-auto w-full max-w-[58rem]"
        ...
        >
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto mb-12 max-w-3xl text-center">
              ...
              >
                How CommonMASS works
              </h2>
              <p className="mt-4 text-lg text-gray-600 dark:text-slate-300">
                The goal is simple: reduce confusion, surface relevant benefits, and give students a
            ...
            <div className="grid gap-10 text-center md:grid-cols-3 md:gap-12 lg:gap-14">
              ...
              >
                ...
                <p className="max-w-sm text-gray-600 dark:text-slate-300 md:text-lg">
                  Complete a brief questionnaire about your student status, household, and common needs
                  like food, transportation, and coverage.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="max-w-sm text-gray-600 dark:text-slate-300 md:text-lg">
                  Review the benefits that may fit your situation, including financial aid, food
                  assistance, health coverage, and transportation support.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="max-w-sm text-gray-600 dark:text-slate-300 md:text-lg">
                  Leave with a personalized checklist that helps you understand next steps, documents,
                  and where to apply.
                </p>
              </motion.div>
            </div>
