// src/app/components/layout/LegalPageShell.tsx
    ...
    <div className="relative isolate min-h-screen overflow-x-hidden bg-[#f8fafc] text-black dark:bg-slate-950 dark:text-slate-100">
      ...
      <main id="main-content" tabIndex={-1} className="px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto max-w-4xl">
          <article className="overflow-hidden rounded-[2rem] border border-white/75 bg-white/82 shadow-[0_34px_80px_-52px_rgba(15,23,42,0.45)] dark:border-white/10 dark:bg-slate-900/80 dark:shadow-[0_28px_80px_-40px_rgba(2,6,23,0.95)]">
            <header className="border-b border-slate-200/70 px-6 py-8 dark:border-white/10 md:px-10 md:py-10">
